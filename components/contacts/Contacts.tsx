    ...
    return (
        ...
        >
            ...
            <div className="flex-1 w-full max-w-5xl mx-auto z-10 flex flex-col justify-center items-center">
                ...
                >
                    <span className="font-playfair italic text-[18vw] md:text-[10vw] leading-[0.8] text-muted-foreground mix-blend-difference select-none text-center">
                        Let&apos;s
                    </span>
                    <span className="font-sans font-black text-[22vw] md:text-[12vw] leading-[0.8] text-gradient-primary tracking-tighter select-none text-center">
                        TALK
                    </span>
                </motion.div>
