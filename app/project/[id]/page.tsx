...
export default function ProjectPage({ params }: { params: { id: string } }) {
    ...
    return (
        <section id='projects' className='flex flex-col items-center justify-start min-h-screen pt-16 px-4 sm:px-6 md:px-8 bg-black text-white'>
            <div className="w-full max-w-4xl mx-auto py-8">
                <header>
                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2">{project.title}</h1>
                    <p className="text-base sm:text-lg md:text-xl text-neutral-400 mb-4">{project.date}</p>
                </header>
